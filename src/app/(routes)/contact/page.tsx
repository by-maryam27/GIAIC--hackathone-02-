export default function Contact(){
  return(
      ...
      <img src="/Group 55 (1).png" alt="img" className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-auto h-auto" />
...
<div className="mb-5">
  <img src="/Group 76.png" alt="Image" />
</div>
</main>
  )
}