...
const CheckoutPage = () => {
  ...
  const initialCart = [
    { id: 1, title: "Elegant Sofa", image: "/singal-sofa.webp", price: "$499", quantity: 1 },
    { id: 2, title: "Modern Coffee Table", image: "/coffee table.jpeg", price: "$199", quantity: 2 },
    { id: 3, title: "Luxurious Armchair", image: "/armchair.jpeg", price: "$299", quantity: 1 },
  ];
