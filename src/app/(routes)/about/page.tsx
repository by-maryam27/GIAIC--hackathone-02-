              ...
              <div className="container mx-auto px-4 sm:px-8 md:px-16">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
                  ...
                  <div className="relative">
                    <img 
                      src="/WhatsApp Image 2024-12-09 at 20.05.03_429475ca.jpg" 
                      alt="Furniture Image" 
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
                    ...
                    <div className="text-center">
                      <div className="w-16 h-16 bg-primary-500 text-white flex items-center justify-center rounded-full mx-auto">
                        <img src="/wtsp(1).jpg" alt="Quality Icon" className="w-8 h-8" />
                      </div>
                    ...
                    <div className="text-center">
                      <div className="w-16 h-16 bg-primary-500 text-white flex items-center justify-center rounded-full mx-auto">
                        <img src="/wtsp(1).jpg" alt="Eco Friendly Icon" className="w-8 h-8" />
                      </div>
                      <h4 className="mt-4 text-xl font-bold text-gray-800">
                        Eco-Friendly
                      </h4>
                    ...
                    <div className="text-center">
                      <div className="w-16 h-16 bg-primary-500 text-white flex items-center justify-center rounded-full mx-auto">
                        <img src="/wt.jpg" alt="Fast Shipping Icon" className="w-8 h-8" />
                      </div>
                      <h4 className="mt-4 text-xl font-bold text-gray-800">
                        Fast Shipping
                      </h4>
                    ...
                    <div className="text-center">
                      <div className="w-16 h-16 bg-primary-500 text-white flex items-center justify-center rounded-full mx-auto">
                        <img src="/tttt.jpg" alt="Support Icon" className="w-8 h-8" />
                      </div>
                      <h4 className="mt-4 text-xl font-bold text-gray-800">
                        24/7 Support
                      </h4>
